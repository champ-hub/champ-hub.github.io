...
layout: page
title: POP Project
description: The Performance Optimisation and Productivity (POP) Centre of Excellence in HPC provides performance optimisation and productivity services for academic AND industrial code(s) in all domains!
img: assets/img/pop_logo.png
importance: 1
category: Research Projects
---

INESC-ID (CHAMP Hub / HPCAS) are official partners of the [POP](https://pop-coe.eu/) project (in the scope of POP3).
